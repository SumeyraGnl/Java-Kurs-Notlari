...
public class EncapsulationKullanimi {
    public static void main(String[] args) {
        ...
        /*
        Encapsulation ; bir class'daki class uyelerine erisim yetkisini
        read ve write olarak birbirinden ayirmadir.
         */

        System.out.println(C03_EncapsuleDatalar.getIsim());  // Yıldız Pazarlama
