...
public class C05_indexOf {
    public static void main(String[] args) {
        ...
        // indexOf , karakterin index numarasini bulur.
        ...
        System.out.println(str.indexOf("cok")); // 5   cok 'u bir butun olarak alir.ilk karsilastigi index 'i verir
        System.out.println(str.indexOf("cok", 6));  // 13
        System.out.println(str.indexOf("cok", 5));  //5

        System.out.println(str.indexOf("java")); //  -1  aranan index yoksa -1 döner(yazdirir)
