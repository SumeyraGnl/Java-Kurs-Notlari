...
public class C01_Update {
    public static void main(String[] args) {
        ...
        okulMap.put(101,"Ali-Cem-10-M-MF"); // ==> 101'deki Ali Cem'in H subesini M yap
        okulMap.put(102,"Kemal-Can-11-M-Soz");//==> 102'deki Veli-Can-10-M-TM 'yi Kemal-Can-11-M-Soz yap
        System.out.println(okulMap);
