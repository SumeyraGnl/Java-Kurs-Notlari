...
public class C01_MapIlkClass {
    public static void main(String[] args) {
        ...
        System.out.println(okulMap); // {101=Ali,  Cem, 10, H, MF, 102=Veli,........
        ...
        System.out.println(okulMap.values());  // [Ali,  Cem, 10, H, MF, Veli, Can, ........]

        // value collection'in icinde kac element vardir?
