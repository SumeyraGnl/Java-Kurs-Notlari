...
public class HAvciKuslar extends GKuslar {
    ...
    public static void main(String[] args) {
        ...
        GKuslar kartalKus= new HAvciKuslar();  // ==> constructore ve data turu farkli ise ovirrede bakilarak
                                               //     yazidirir
        ...
        FHayvanlar hayvanlar = new FHayvanlar();  // ==> constructore ve data turu ayni ise ovirrede bakilmaz
                                                  //     ilk buldugunu yazidirir
        ...
        /*
            ...
            o class'da aramaya baslar
            buldugu ilk degeri kullanir
